...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Prepare arrays to store errors and old input
    $_SESSION['errors'] = [];
    $_SESSION['old'] = [
        'name' => $name,
        'age' => $age,
    ...
    if (empty($age)) {
        ...
        $_SESSION['errors']['ageError'] = "Please enter a valid age between 1 and 120.";
    }
    ...
    // Check if email already exists only if no email validation error
